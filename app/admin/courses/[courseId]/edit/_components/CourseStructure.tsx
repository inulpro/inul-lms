...
import { AdminCourseIdType } from "@/app/data/admin/admin-get-course";
  ...
  function handleDragEnd(event: DragEndEvent) {
    ...
    if (activeType === "lesson" && overType === "lesson") {
      ...
      if (!chapterId || chapterId !== overChapterId) {
        toast.error(
          "Cannot move lesson between different chapters or invalid chapter"
        );
        return;
      }
      ...
      if (chapterIndex === -1) {
        toast.error("Could not find the chapter for lesson reordering");
        return;
      }
